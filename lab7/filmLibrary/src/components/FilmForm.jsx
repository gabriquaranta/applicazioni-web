...
const FilmForm = (props) => {
  ...
  const [favorite, setFavorite] = useState(
    props.film ? props.film.favorite : false
  );
  const [watchDate, setWatchDate] = useState(
    props.film && props.film.watchDate
  ...
  return (
    <Form
      className="block-example border border-primary rounded mb-0 form-padding"
    ...
    >
      ...
      &nbsp;
      <Link to="/">
        <Button className="mb-3" variant="danger" onClick={props.cancel}>
          Cancel
        </Button>
      </Link>
    </Form>
